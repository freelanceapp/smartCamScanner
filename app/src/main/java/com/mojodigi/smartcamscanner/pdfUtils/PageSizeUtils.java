...
import static com.mojodigi.smartcamscanner.Constants.Constants.DEFAULT_PAGE_SIZE_TEXT;
...
public class PageSizeUtils {
    ...
    public PageSizeUtils(Context mActivity) {
        ...
        mDefaultPageSize = mSharedPreferences.getString(DEFAULT_PAGE_SIZE_TEXT,
                DEFAULT_PAGE_SIZE);
        ...
        return builder.customView(R.layout.set_page_size_dialog, true)
                .onPositive((dialog1, which) -> {
                    ...
                    if (saveValue || mSetAsDefault.isChecked() ) {
                        ...
                        editor.putString(DEFAULT_PAGE_SIZE_TEXT, mPageSize);
                        editor.apply();
                    }
                }).build();
    }
